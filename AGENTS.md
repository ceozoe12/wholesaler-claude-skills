# Wholesaler Codex Skills — by CyclSales

## What This Is
AI-powered tools for real estate wholesalers. Give Codex an address and it pulls everything you need.
...
| **Codex in Chrome** | County assessor/trustee lookups (interactive forms) | Optional |
